...
class ImagenGenerator:
    ...
    def __init__(self, output_dir: Path = None):
        self.client = get_gemini_client()
        self.model = get_model("thumbnail")  # 最新のImagen 4.0
        ...
        try:
            ...
            if response.generated_images:
                ...
                if hasattr(image_data, 'image') and hasattr(image_data.image, 'image_bytes'):
                    ...
                    # base64の場合
                    image_bytes = base64.b64decode(image_data.image.image_bytes)
                    with open(output_path, "wb") as f:
                        f.write(image_bytes)
...
class VeoGenerator:
    ...
    def __init__(self, output_dir: Path = None):
        self.client = get_gemini_client()
        self.model = get_model("opening_video")  # 正式なVeo 2モデル
        ...
        try:
            ...
            if response.generated_videos:
                ...
                if hasattr(video_data, 'video') and hasattr(video_data.video, 'video_bytes'):
                    ...
                    video_bytes = base64.b64decode(video_data.video.video_bytes)
                    with open(output_path, "wb") as f:
                        f.write(video_bytes)
