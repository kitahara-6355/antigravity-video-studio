...
def test_process_pre_production_neutral():
    ...
    with patch("plugins.youtube_optimizer_plugin.YouTubeOptimizerPlugin.calculate_dynamic_ctr", return_value=4.5), \
...
def test_process_pre_production_agree():
    ...
    with patch("plugins.youtube_optimizer_plugin.YouTubeOptimizerPlugin.calculate_dynamic_ctr", return_value=5.5), \
         patch("agents.analyst.HAS_ADK", False):
        res = analyst.process(input_data, {})
...
def test_process_pre_production_disagree():
    ...
    with patch("plugins.youtube_optimizer_plugin.YouTubeOptimizerPlugin.calculate_dynamic_ctr", return_value=3.5), \
         patch("agents.analyst.HAS_ADK", False):
        res = analyst.process(input_data, {})
...
def test_process_pre_production_with_distilled_knowledge():
    ...
    with patch("plugins.youtube_optimizer_plugin.YouTubeOptimizerPlugin.calculate_dynamic_ctr", return_value=4.0), \
         patch("agents.analyst.HAS_ADK", False):
...
def test_run_adk_bridge_success():
    ...
    with patch("plugins.youtube_optimizer_plugin.YouTubeOptimizerPlugin.calculate_dynamic_ctr", return_value=5.0), \
...
def test_process_pre_production_wagamama_less_than_five_items():
    ...
    with patch("plugins.youtube_optimizer_plugin.YouTubeOptimizerPlugin.calculate_dynamic_ctr", return_value=4.0),          patch("agents.analyst.HAS_ADK", False):
...
def test_process_pre_production_ctr_upper_limit():
    ...
    with patch("plugins.youtube_optimizer_plugin.YouTubeOptimizerPlugin.calculate_dynamic_ctr", return_value=14.8),          patch("agents.analyst.HAS_ADK", False):
...
def test_process_pre_production_missing_text():
    ...
    with patch("plugins.youtube_optimizer_plugin.YouTubeOptimizerPlugin.calculate_dynamic_ctr", return_value=4.2),          patch("agents.analyst.HAS_ADK", False):
        res = analyst.process(input_data, {})
        assert res["stance"] == "NEUTRAL"
...
def test_process_pre_production_query_none():
    ...
    with patch("plugins.youtube_optimizer_plugin.YouTubeOptimizerPlugin.calculate_dynamic_ctr", return_value=3.0) as mock_calc, \
         patch("agents.analyst.HAS_ADK", False):
        res = analyst.process(input_data, {})
        assert res["stance"] == "DISAGREE"
