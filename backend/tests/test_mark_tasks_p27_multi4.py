...
class TestMarkTasksP27Multi4(unittest.TestCase):
    ...
    def test_main(self, mock_hub_class):
        ...
        from backend.agents.orchestration.mark_tasks_p27_multi4 import main
        ...
        with patch('builtins.print') as mock_print:
            ...
            mock_hub.mark_task_done.assert_any_call("T-batch_881c02-refactor-000", "pass", {
            ...
            mock_hub.mark_task_done.assert_any_call("T-batch_881c02-thumbnail-001", "pass", {
    ...
    def test_main_execution_block(self, mock_hub_class):
        ...
        script_path = str(backend_dir / 'agents' / 'orchestration' / 'mark_tasks_p27_multi4.py')
