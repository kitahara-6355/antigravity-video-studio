...
class VideoProcessor:
    ...
    def _record_soul_narrative(self, task_id: str, output_name: str, settings: MoodSettings, scene_count: int):
        ...
        try:
            ...
            logger.warning(f"Failed to record Soul Narrative: {e}")
        ...
        try:
            ...
            def parse_progress():
                ...
                while process.poll() is None:
                    ...
                    # Duration取得（例: Duration: 00:01:30.00）
            ...
            if process.returncode == 0:
                ...
                logger.error(f"❌ {description} failed: {stderr_output[-300:] if stderr_output else ''}")
                return False
    ...
    def _process_scene(self, input_path: str, output_path: str, settings: MoodSettings,
        ...
        if not success:
            ...
            try:
                ...
                logger.error(f"Copy also failed: {e}")
