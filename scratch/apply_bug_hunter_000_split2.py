...
def main():
    ...
    worktree = r"C:/Users/PC_User/.gemini/antigravity/brain/ddc38d7b-e9dc-4aaf-b3d4-0642d02ef4b1/.system_generated/worktrees/subagent-bug-hunter-Agent-000-split2-self-adefc0cf"
    ...
    # Mark task as pass
    task_id = "T-batch_8b2dd3-bug_hunter-000-split2"
    report = {
        "message": "tests/test_run_session_end.py 境界値およびエッジケースを網羅した単体テスト追加完了。RuntimeWarning対策適用。12 passed を確認。",
