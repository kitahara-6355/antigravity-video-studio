...
def main():
    ...
    worktree = r"C:/Users/PC_User/.gemini/antigravity/brain/ddc38d7b-e9dc-4aaf-b3d4-0642d02ef4b1/.system_generated/worktrees/subagent-bug-hunter-Agent-003-self-38ee5005"
    
    targets = [
        "backend/agents/orchestration/wave_scheduler.py",
        "backend/agents/orchestration/resource_governor.py",
    ...
    # Mark task as pass
    task_id = "T-batch_6de532-bug_hunter-003"
    report = {
        "message": "wave_scheduler.py, resource_governor.py バグ修正完了。test_wave_scheduler.py のテストが全て正常に PASS しました。",
