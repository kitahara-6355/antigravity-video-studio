...
def main():
    ...
    worktree = r"C:/Users/PC_User/.gemini/antigravity/brain/ddc38d7b-e9dc-4aaf-b3d4-0642d02ef4b1/.system_generated/worktrees/subagent-bug-hunter-Agent-004-self-d566f733"
    ...
    # Mark task as pass
    task_id = "T-batch_6de532-bug_hunter-004"
    report = {
        "message": "verify_council_v2.py 型チェック・存在検証厳格化完了。test_verify_council_v2.py が全て正常に PASS しました。",
