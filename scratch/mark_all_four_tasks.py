...
def main():
    ...
    task_id_thumb0 = "T-batch_556530-thumbnail-000"
    report_thumb0 = {
    ...
    print(f"Marking task {task_id_thumb0} as pass...")
    hub.mark_task_done(task_id_thumb0, "pass", report_thumb0)

    # 4. Mark thumbnail-001
    task_id_thumb1 = "T-batch_556530-thumbnail-001"
    report_thumb1 = {
        "message": "comprehensive_preview.py に関し、解像度 1280x720 以上、アスペクト比 16:9、ファイルサイズ 4MB 未満、Pillow健全ロード、StageBoundAgent連携を含む自動検証テストをクリア。例外ハンドリングのTDR登録も実施。",
        "changed_files": ["backend/comprehensive_preview.py"]
    }
    print(f"Marking task {task_id_thumb1} as pass...")
    hub.mark_task_done(task_id_thumb1, "pass", report_thumb1)

    # 心拍とステータス更新
    hub.flash_update_heartbeat()
    status = hub.generate_flash_status()
    print("--- Flash Status After Marking All ---")
