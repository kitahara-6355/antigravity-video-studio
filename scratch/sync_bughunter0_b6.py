...
def sync():
    ...
    files_to_copy = [
        ("backend/scratch/check_worktree_git.py", "backend/scratch/check_worktree_git.py"),
        ("backend/tests/test_scratch_check_worktree_git.py", "backend/tests/test_scratch_check_worktree_git.py")
    ]

    for src_rel, dest_rel in files_to_copy:
        src_path = os.path.join(wt_bughunter0, src_rel)
