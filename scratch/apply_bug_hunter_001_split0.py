...
def main():
    ...
    worktree = r"C:/Users/PC_User/.gemini/antigravity/brain/ddc38d7b-e9dc-4aaf-b3d4-0642d02ef4b1/.system_generated/worktrees/subagent-bug-hunter-Agent-001-split0-self-8200f500"
    ...
    # Mark task as pass
    task_id = "T-batch_8b2dd3-bug_hunter-001-split0"
    report = {
        "message": "tests/_e2e_cycle3.py 設計スタブの定義完了。テスト追加。21 passed を確認。",
