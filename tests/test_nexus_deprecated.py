...
def test_wrapper_nexus_init(caplog):
    import logging
    from agents.nexus import Nexus as WrapperNexus
...
def test_wrapper_nexus_process():
    from agents.nexus import Nexus as WrapperNexus
    ...
    assert "Strategist" in res["needed_agents"]


def test_wrapper_nexus_synthesize():
    from agents.nexus import Nexus as WrapperNexus
...
def test_nexus_process_json_decode_failure():
    nexus = Nexus()
...
def test_nexus_synthesize_json_decode_failure():
    nexus = Nexus()
